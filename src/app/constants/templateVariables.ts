export const TEMPLATE_VARIABLES = [
    ...
    },
    {
        ...
        items: [
            ...
            { tag: "{{PRESENTANTE_PERSONA}}", label: "Presentante (Persona)" },
            { tag: "{{DUA}}", label: "DUA N°" },
    ...
    {
        category: "Datos de Empresa Gestora",
        items: [
            { tag: "{{EMPRESA_NOMBRE}}", label: "Razón Social" },
            { tag: "{{EMPRESA_RUC}}", label: "RUC Empresa" },
            { tag: "{{EMPRESA_DIRECCION}}", label: "Dirección Empresa" },
            { tag: "{{EMPRESA_REPRESENTANTES}}", label: "Representantes Legales" },
        ]
    },
    {
        category: "Sistema",
        items: [
            { tag: "{{FECHA_IMPRESION}}", label: "Fecha de Impresión" },
        ]
    }
];